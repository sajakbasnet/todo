...
import com.example.todouser.tabviemodel.TaskActivityViewModelp2;
import com.example.todouser.tasks.TaskAdapter;

import java.util.List;

public class priority2fragment extends Fragment implements TaskAdapter.ItemClickListener {

    public priority2fragment(){
        //
    }
    TaskDao td;
    TaskEntry taskEntry;
AppDatabase appdatabase;
    ...
    TaskActivityViewModelp2 viewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(requireActivity()).get(TaskActivityViewModelp2.class);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fabButton.setOnClickListener(new View.OnClickListener() {
            ...
            viewModel.getTaskByPriority2().observe(getActivity(), new Observer<List<TaskEntry>>() {
                @Override
