...
import com.example.todouser.tabviemodel.TaskActivityViewModelp3;
import com.example.todouser.tasks.TaskAdapter;

import java.util.List;

public class priority3fragment extends Fragment implements TaskAdapter.ItemClickListener {

    public priority3fragment(){
        //
    }
    TaskDao td;
    TaskEntry taskEntry;
AppDatabase appdatabase;
    ...
    TaskActivityViewModelp3 viewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(requireActivity()).get(TaskActivityViewModelp3.class);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            viewModel.getTaskByPriority3().observe(getActivity(), new Observer<List<TaskEntry>>() {
                @Override
